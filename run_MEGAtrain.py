...
def get_dataloader(trainer: DistributedTrainer): # Modificar esta funcion que al final es todo el script jajajajaja
    """Returns a dataloader for training."""

    # First, we need to know which ranks to feed the dataloader to
    input_pp_rank, output_pp_rank = get_input_output_pp_ranks(model=trainer.model) # No lo he mirado en profundidad, pero al inicializar el modelo (dentro de trainer) debe de establecer cual es el rango del primer y ultimo modulo donde esperara el input y el output
...
if __name__ == "__main__":
    ...
    dataloader = get_dataloader(trainer) # modificar esta funcion
