...
def get_sampler(
    ...
    if consumed_train_samples > 0:
        # TODO Batches or samples??????? claro me saldria bien porque mi micro batch size era de 1 por lo que
        # cada batch == sample. Pero claro, viene del sampler ya, que esta construido con 
        # el dp rank ya.... pensar pensar bien macho vaya mierda, si parecia que habia salido bien ya no????
        # Pero claro, debe de estar bien, porque en verdad cada sample del batch sampler da 1 batch
